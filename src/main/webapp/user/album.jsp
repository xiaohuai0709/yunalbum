...
<html>
  ...
  <a href="<%=path%>/user/addalbum.jsp" >创建相册</a>
  ...
  <div >
  <img  src="<%=path%>/img/1.jpg" style="width: 200;height: 200" ><br>
  文件夹1<br>
  <img  src="<%=path%>/img/3.jpg" style="width: 200;height: 200" ><br>
  文件夹2<br>
  </div>
  <div >
  <img  src="<%=path%>/img/3.jpg" style="width: 200;height: 200" ><br>
  文件夹3<br>
  <img  src="<%=path%>/img/4.jpg" style="width: 200;height: 200" ><br>
  文件夹4<br>
  </div>
  </div>
  </body>
